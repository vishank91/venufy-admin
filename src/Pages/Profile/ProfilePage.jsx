...
import { getProfile } from "../../Redux/ActionCreators/ProfileActionCreators";
      ...
      <div className="container-xxl container-p-y">
        <div className="card">
          <div className="card-body text-center">
            <h4>No Vendor Profile Found</h4>
            <p className="text-muted">Please create your vendor business profile first.</p>
          ...
          <div className="card h-100">
            <div className="card-body text-center">
              <div className="avatar avatar-xl mx-auto mb-3">
                <span className="avatar-initial rounded-circle bg-label-primary">{(profile.businessName || "V").charAt(0).toUpperCase()}</span>
              </div>
            ...
            <div className="card-body">
              <div className="row">
                <div className="col-sm-6 mb-3">
                  ...
                  <div className="fw-semibold">{profile.businessName || "-"}</div>
                </div>

                <div className="col-sm-6 mb-3">
                  <small className="text-muted">Business Type</small>
                  <div className="fw-semibold">{profile.businessType || "-"}</div>
                </div>

                <div className="col-sm-6 mb-3">
                  <small className="text-muted">Business Email</small>
                  <div className="fw-semibold">{profile.businessEmail || "-"}</div>
                </div>

                <div className="col-sm-6 mb-3">
                  <small className="text-muted">Business Phone</small>
                  <div className="fw-semibold">{profile.businessPhone || "-"}</div>
                </div>

                <div className="col-sm-6 mb-3">
                  <small className="text-muted">Alternate Phone</small>
                  <div className="fw-semibold">{profile.alternateBusinessPhone || "-"}</div>
                </div>

                <div className="col-sm-6 mb-3">
                  <small className="text-muted">Established Year</small>
                  <div className="fw-semibold">{profile.establishedYear || "-"}</div>
                </div>

                <div className="col-12 mb-3">
                  <small className="text-muted">Website</small>
                  <div className="fw-semibold">{profile.website || "-"}</div>
                </div>

                <div className="col-12">
                  <small className="text-muted">Description</small>
                  <div className="fw-semibold">{profile.description || "-"}</div>
                </div>
              </div>
            </div>
          </div>
