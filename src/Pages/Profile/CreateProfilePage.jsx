          ...
          <div className="card-body">
            <div className="row">
              <div className="col-md-6 mb-3">
                ...
                <input name="category" className="form-control" value={form.category} onChange={changeInput} required />
              </div>
              <div className="col-md-6 mb-3">
              ...
              <div className="col-12 mb-3">
                ...
                <input type="url" name="website" className="form-control" value={form.website} onChange={changeInput} />
              </div>
