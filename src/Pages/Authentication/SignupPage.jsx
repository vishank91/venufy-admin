...
export default function SignupPage() {
  ...
  useEffect(() => {
    if (auth.response?.result === "Done" && auth.response?.id) {
        ...
        <div className="authentication-inner row">
          ...
          <div className="d-flex col-12 col-lg-6 align-items-center p-sm-5 p-4">
            <div className="w-px-400 mx-auto">
              ...
              {(serverError || (show && Object.values(errorMessage).find((x) => x !== ""))) && (
                <div className="alert alert-danger">{serverError || Object.values(errorMessage).find((x) => x !== "")}</div>
              )}
                ...
                <div className="row">
                  ...
                  <div className="col-md-6 mb-3 form-password-toggle">
                    ...
                    {show && errorMessage.password
                      ? errorMessage.password.split("|").map((item, index) => {
                          return (
                  ...
                  <div className="col-md-6 mb-3 form-password-toggle">
                    ...
                    <div className="input-group input-group-merge">
                      <input
                        type={showPassword ? "text" : "password"}
                        id="cpassword"
                        className={`form-control ${show && errorMessage.password === "Password and Confirm Password Doesn't Matched" ? "border-danger" : ""}`}
                        name="cpassword"
                  ...
                  <button type="submit" className="btn btn-primary d-grid w-100" disabled={auth.loading}>
                    {auth.loading ? (
                      <>
