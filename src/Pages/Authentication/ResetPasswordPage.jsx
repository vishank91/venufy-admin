...
export default function ResetPasswordPage() {
  ...
  useEffect(() => {
    if (auth.response?.result === "Done" && auth.response?.message === "Password reset successfully.") {
            ...
            <form onSubmit={postSubmit}>
              <div className="mb-3">
                ...
                <div className="input-group input-group-merge">
                  <input type={showPassword ? "text" : "password"} className="form-control" value={password} onChange={(e) => setPassword(e.target.value)} placeholder="Enter new password" />
